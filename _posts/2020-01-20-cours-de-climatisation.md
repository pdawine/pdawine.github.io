...
<img width="150" src="https://latex.codecogs.com/svg.latex?\color{white}\Large&space;v = \frac{v}{m}" /><br>
...
<img width="150" src="https://latex.codecogs.com/svg.latex?\color{white}\Large&space;PV = N\bar{R}T" />
